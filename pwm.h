...
#define GPIO_TIMER_ROUTEEN_CC_PIN_ENABLE_VAL          1UL
#define GPIO_TIMER_CCROUTE_PIN_SHIFT                  16
#define GPIO_OUT_LOW                                  0
#define GPIO_OUT_HIGH                                 1

/*      END OF REGISTER VALUE DEFINITIONS       */

/*      LIBRARY PARAMETER DEFINITIONS     */

#define MIN_PWM_FREQUENCY                 650
#define DIMMING_SCALE                     1000
#define MAX_POSSIBLE_NUM_OF_TIMERS        10
#define MIN_NUM_OF_CHANNELS               1
#define MAX_NUM_OF_CHANNELS               3

/*      END OF LIBRARY PARAMETER DEFINITIONS     */
